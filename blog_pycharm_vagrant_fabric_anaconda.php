...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <p>I decided to see how I could make that setup a bit more portable
                and easier
                to deploy.
            </p>
            ...
            <p>The following guide assume that you have that you have
                ...
                although it should pretty much be platform
                agnostic.
            </p>
            ...
            <ul>
                <li>
                    <p>On your local filesystem, in your development workspace,
                        create a directory
                        <strong><span
                                class="text-primary">colour-science</span></strong>
                        and
    ...
    cd colour-science</pre>
                ...
                <li>
                    ...
                    <p>You should now have a
                        <strong><span
                                class="text-primary">colour-vagrant</span></strong>
                        directory nested into the
                        <strong><span
                                class="text-primary">colour-science</span></strong>
                        one.
                    </p>
                    Let's open the <strong><span class="text-primary">colour-vagrant</span></strong>
                    directory into
                    <a href="http://www.jetbrains.com/pycharm/">PyCharm</a>.
                </li>
            </ul>
            ...
            <p>We will loosely follow
                <a href="http://www.jetbrains.com/pycharm/quickstart/configuring_for_vm.html">Jetbrain's
                    PyCharm
                    Documentation</a>.
            </p>
            <ul>
                ...
                <li>
                    <p>Install
                        <a href="http://www.fabfile.org/">Fabric</a>, this is
                        the provider needed for the
                        <a href="https://github.com/colour-science/colour-vagrant">colour-vagrant</a>
                        environment:
                    </p>
                    ...
                    <p>Initially, I was provisioning with
                        ...
                        <a href="https://github.com/hlassiege/fabric-vagrant">fabric-vagrant</a>
                        plugin.
                    </p>
                </li>
                <li>
                    <p>Install
                        <a href="http://xquartz.macosforge.org/">XQuartz</a>:
                        This is the X11 display server for
                        <strong><span
                                class="text-primary">Mac Os X</span></strong>.
                        The virtual machine will export the
                        display to
                        it so that you can see the figures from
                        <a href="http://matplotlib.org/">Matplotlib</a>.
                    </p>
                </li>
                <li>
                    <p>
                        <a href="https://www.virtualbox.org/">VirtualBox</a>
                        directories syncing performance degrades
                        quickly with
                    ...
                    <p>You will however be asked for your
                        <strong><span
                                class="text-primary">Mac Os X</span></strong>
                        password at each virtual machine
                        spin up because
                        <a href="https://www.vagrantup.com/">Vagrant</a> needs
                        to modify configuration files on the
                        <strong><span
                                class="text-primary">Mac Os X</span></strong>
                        host.
                    </p>
                    ...
                    <p>In order to avoid that and following the
                        <a href="https://docs.vagrantup.com/v2/synced-folders/nfs.html">Vagrant
                            Documentation</a>, you
                        can edit your
                        <strong><span
                                class="text-primary">Mac Os X</span></strong>
                        <strong><span class="text-primary">/etc/sudoers</span></strong>
    ...
    %admin ALL=(root) NOPASSWD: VAGRANT_EXPORTS_ADD, VAGRANT_NFSD, VAGRANT_EXPORTS_REMOVE</pre>
            ...
            <p>The canonical way is to use
                <a href="https://www.vagrantup.com/">Vagrant</a> from the
                command line as described in
                <a href="https://docs.vagrantup.com/v2/getting-started/">Vagrant
                    Documentation</a>, but here we will
                leverage the
                <a href="http://www.jetbrains.com/pycharm/">PyCharm</a>
                integration.
            </p>
            <ul>
                <li>
                    <p>Set the
                        <strong><span
                                class="text-primary">Instance Folder</span></strong>
                        field to your
                        <strong><span
                                class="text-primary">colour-vagrant</span></strong>
                        directory.
                ...
                <li>
                    <p>Add a new
                        ...
                        in the
                        <strong><span
                                class="text-primary">Boxes</span></strong> tab
                ...
                <li>
                    <p>Add the
                        ...
                        in the
                        <strong><span
                                class="text-primary">Plugins</span></strong>
                        tab.
                    </p>
                </li>
            </ul>

            <p>Your configuration screen should be approximately as
                follows:</p>
            <img src="images/Blog_PyCharm_Vagrant_001.png"
                 class="img-responsive">
            <img src="images/Blog_PyCharm_Vagrant_002.png"
                 class="img-responsive">

            <h3>Vagrant Up</h3>

            <p>With everything setup, hit the
                <strong><span class="text-primary">PyCharm ---> Tools ---> Vagrant ---> Up</span></strong>
                menu item to
                spin up the
                virtual machine.
            </p>

            <p>You can go grab a coffee, the initial provisioning will take
                roughly 25-30 minutes.</p>

            <p>If the provisioning ended smoothly, you should have the
                following elements available:</p>
            <ul>
                <li>
                    <p>
                        <strong><span
                                class="text-primary">colour</span></strong>,
                        <strong><span
                                class="text-primary">colour-ipython</span></strong>
                        and
                        <strong><span
                                class="text-primary">colour-website</span></strong>
                        repositories cloned into the
                        <strong><span
                                class="text-primary">colour-science</span></strong>
                ...
                <li>
                    <p>Remote Python environments installed into the virtual
                        machine at the following location with all
                        the
                        dependencies needed:
                    </p>
    ...
    drwxrwxr-x 11 vagrant vagrant 4096 Sep  5 09:58 python3.4/
                ...
                <li>
                    <p>The
                        <strong><span
                                class="text-primary">colour-science.org</span></strong>
                        website served from the
                        virtual
                        machine at the following address:
            ...
            <ul>
                <li>
                    <p>Add the various remote Python interpreters to
                        ...
                        <a href="http://www.jetbrains.com/pycharm/quickstart/configuring_interpreter.html">Remote
                            interpreter via
                            virtual box: 2</a>
                    </p>
                ...
                <li>
                    <p>Add the paths mappings from the
                        <strong><span
                                class="text-primary">Mac Os X</span></strong>
                        host to the virtual machine in the
                        <strong><span
                                class="text-primary">Defaults</span></strong>
                        configurations, in my case the
                        mappings are as
                        follows:
                    </p>
                    <code>/Users/KelSolaar/Documents/Developement/colour-science
                        = /colour-science</code>
                </li>
            </ul>
            <p>Your Run/Debug configuration screen should be approximately
                looking like that:</p>
            <img src="images/Blog_PyCharm_Configurations_001.png"
                 class="img-responsive">
            <img src="images/Blog_PyCharm_Configurations_002.png"
                 class="img-responsive">
            ...
            <p>Accessing the virtual machine is done by using
                <strong><span class="text-primary">PyCharm ---> Tools Start SSH session...</span></strong>
                menu item.
            </p>

            <p>However if you want to be able to export the display and see the
                figures you will have to manually
            ...
            <p>You will also need to add the virtual machine to the X11 hosts
                by issuing the following command on the
                <strong><span class="text-primary">Mac Os X</span></strong>
                host:
            </p>
