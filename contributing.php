...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <ul>
                <li>Reporting a defect, proposing a new feature or enhancement or commenting existing issues on the
                    <a href="https://github.com/colour-science/colour/issues"><span class="fa fa-github">&nbsp;Issue Tracker</span>
                    </a>
                </li>
                <li>
                    Contributing new code by implementing new features or adding examples, for some ideas you can take a look at the issues with the
                    <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3AEnhancement">Enhancement</a>,
                    <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3AFeature">Feature</a> and
                    <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3AReady">Ready</a> labels or the
            ...
            <p>The three major issue types one can report on the issue tracker are the following:
                <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3ADefect">Defect</a>,
                <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3AEnhancement">Enhancement</a> and
            ...
            <ul>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3AMajor">Major</a>: Used for issues which have significant consequences on the ability of people to work but do not lead to the whole API being unusable.
                        </li>
                        <li>
                            <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3ANormal">Normal</a>: Used for issues affecting one piece of functionality. Those are usually self-contained and don't impact the overall functionality of the API.
                        </li>
                        <li>
                            <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3AMinor">Minor</a>: Used for cosmetic issues that don't prevent the API to run properly.
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3AP2">P2</a>: Used for average priority.
                        </li>
                        <li>
                            <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3AP3">P3</a>: Used for the lowest priority.
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3AAPI">API</a>: Used for issues related to the API.
                </li>
                <li>
                ...
                <li>
                    <a href="https://github.com/colour-science/colour/issues?q=is%3Aclose+is%3Aissue+label%3ADiscarded">Discarded</a>: Used for a discarded / canceled issue.
                </li>
                <li>
                    <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3ADuplicate">Duplicate</a>: Used for a duplicate issue.
                </li>
                <li>
                    <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3APostponed">Postponed</a>: Used for an issue postponed for a future milestone.
                </li>
                <li>
                    <a href="https://github.com/colour-science/colour/issues?q=is%3Aopen+is%3Aissue+label%3AReady">Ready</a>: Used for an issue ready to be addressed.
                </li>
            </ul>
            <h4>Defects</h4>

            <p>You encountered a problem while using
                <strong><span class="text-primary">Colour</span></strong>, please consider reporting it on the
                <a href="https://github.com/colour-science/colour/issues"><span class="fa fa-github">&nbsp;Issue Tracker</span>
                </a>.
            </p>

            <p>The first thing to do, is to check if there are any existing issues describing your problem, if there is one, you are welcome commenting into it and provide more details. However, please avoid creating duplicates, they add noise to the issue tracker and we will have to label them as
            ...
            <p>
                We are also running
                <a href="http://www.mathworks.fr/products/matlab/">Matlab</a>, so don't hesitate to provide snippets for it if you have functions you would like to be ported.
            </p>
            ...
            <p>Here is a succinct overview of the steps you will most likely go through:</p>
            <ol>
                <li>
                ...
                <li>
                    ...
                    <em><span class="text-info">upstream</span></em> repository by adding it as a remote:
...
» git commit -m 'Implement "Mie Scattering" support'.</pre>
                ...
                <li>
                    ...
                    <em><span class="text-info">origin</span></em>, your own fork:
            ...
            <p>We follow the
                <a href="https://google-styleguide.googlecode.com/svn/trunk/pyguide.html">Google Python Style Guide</a> and especially the
                <em><span class="text-info">Python Language Rules</span></em> although with the main exception being the doctrings / documentation formatted with
                <a href="https://github.com/numpy/numpy/blob/master/doc/example.py">Numpy Docstrings Style</a>.
            </p>
    ...
    return x, y</pre>
            ...
            <p>For those cases, and there are legions of them in Colour Science, we have decided to go for clarity and consistency with the literature for the object names:</p>
            <pre>def XYZ_to_xy(XYZ):
    X, Y, Z = np.ravel(XYZ)
    x, y = X / (X + Y + Z), Y / (X + Y + Z)
    return x, y</pre>
            ...
            <ul>
                <li>Ensure consistency with Colour Science literature first.</li>
                <li>Ensure
...
array([ 100.        ,   17.5066479...,  244.9304684...])</pre>
                ...
                <li>Some commonly used dataset elements have aliases like
                    <strong><span class="text-primary">'cie_2_1931'</span></strong> for
                    <strong><span class="text-primary">'CIE 1931 2 Degree Standard Observer'</span></strong>. Those are provided for convenience and are reserved for external usage, please use the long form for consistency across the API.
                <li>In the same way as above, some computation methods are using a title case like
