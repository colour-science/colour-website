...
<div class="col-md-3">
    <div class="row">
        <div>
            ...
            <a href="https://github.com/colour-science/colour/archive/v0.3.1.zip">
                <button type="button" class="btn btn-primary btn-lg btn-block">
                    <i class="fa fa-download"></i>&nbsp;Colour 0.3.1 Alpha
                </button>
            </a>
        </div>
        <div>
        ...
        <div>
            ...
            <a class="twitter-timeline" href="https://twitter.com/colour_science" data-widget-id="499223432198758400">Tweets by @colour_science</a>
